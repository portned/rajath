...
Now calculating the **mean_ of _X_ with _n_ number of data by using the formula
...
The variance of _X_ is 6.6667 and that of _Y_ is 3.3335. Which tells us that the data of `X` is more varied or spread across than the data of _Y_
